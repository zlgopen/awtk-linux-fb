...
COMPILE_CONFIG = {
  ...
  'OPENGL_ANTIALIAS' : { 'value' : None, 'type' : str.__name__, 'str_enum' : ['HW', 'SW', 'NONE'], 'desc' : ['value is HW/SW/NONE, and value\'s type is str', 'Default value is SW', 'HW is platform\'s MultiSample antialias, SW is VGCANVAS\'s soft antialias, NONE is no antialias'], 'help_info' : 'Set OpenGL antialiasing mode (HW/SW/NONE), OPENGL_ANTIALIAS = "HW" ' },
