...
COMPILE_CONFIG = {
  'OS_FLAGS' : { 'value' : None, 'desc' : ['compile flags'], 'help_info' : 'set compile\'s flags, so care of system and compile tools'},
  'OS_LINKFLAGS' : { 'value' : None, 'desc' : ['link flags'], 'help_info' : 'set compile\'s link flags, so care of system and compile tools'},
  ...
  'INPUT_ENGINE' : { 'value' : None, 'desc' : ['null/spinyin/t9/t9ext/pinyin'], 'help_info' : 'set awtk use input engine' },
  'VGCANVAS' : { 'value' : None, 'desc' : ['NANOVG/NANOVG_PLUS/CAIRO'], 'help_info' : 'set awtk use render vgcanvas type' },
  ...
  'LCD_DEVICES' : { 'value' : None, 'desc' : ['linux\'s lcd devices type, value is fb/drm/egl_for_fsl/egl_for_x11/egl_for_gbm'], 'help_info' : 'when building, use linux\'s lcd devices type, value is fb/drm/egl_for_fsl/egl_for_x11/egl_for_gbm' },
